...
import {openTipsLibrary, openDebugModal, openAssistantModal} from '../../reducers/modals';
...
const ariaMessages = defineMessages({
    ...
    assistant: {
        id: 'gui.menuBar.assistant',
        defaultMessage: 'Storyboard',
        description: 'accessibility text for the storyboard button'
    }
});
...
MenuBar.propTypes = {
    ...
    onOpenAssistantModal: PropTypes.func,
...
const mapDispatchToProps = dispatch => ({
    ...
    onOpenAssistantModal: () => dispatch(openAssistantModal()),
